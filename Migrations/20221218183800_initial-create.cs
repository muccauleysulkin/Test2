    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FavouriteTeam = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FavouritePlayer = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatefGame = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BasketballNiId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FixturesAndResults", x => x.Match_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rebounds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Assists = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Blocks = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Steals = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BasketballNiId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
